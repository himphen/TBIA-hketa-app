...
import hibernate.v2.sunshine.ui.eta.edit.leanback.EditEtaDialogFragment.Companion.ACTION_ID_REMOVE
import hibernate.v2.sunshine.util.swap
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import org.koin.android.ext.android.inject

class EtaEditFragment : VerticalGridSupportFragment() {
    ...
    companion object {
        ...
        fun getInstance() = EtaEditFragment()
    }
